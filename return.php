...
$get_pro = "SELECT * FROM orders WHERE status = 2 ORDER BY order_date DESC LIMIT $offset, $items_per_page";
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">View Return Items</h3>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="returnitemdiv">
                                            ...
                                            <p class="text3">Please review the summary of returned items below. You can approve or reject the returns based on the provided information.</p>
                                            <div class="div3">
                                                <a href="update_status.php?status=3&orderid=<?php echo $order_id; ?>" style=" color: #337ab7; text-decoration: none; ">Approve</a>
                                                <a href="update_status.php?status=4&orderid=<?php echo $order_id; ?>" style=" color: #337ab7; text-decoration: none; ">Reject</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="pagination">
                    <ul class="pagination">
                        <?php if ($current_page > 1) : ?>
                            <li><a href="http://localhost/envisionprint/admin.php?return&page=<?php echo $current_page - 1; ?>">&laquo; Previous</a></li>
                        <?php endif; ?>

                        <?php for ($page = 1; $page <= $total_pages; $page++) : ?>
                            <li <?php if ($page == $current_page) echo 'class="active"'; ?>>
                                <a href="http://localhost/envisionprint/admin.php?return&page=<?php echo $page; ?>"><?php echo $page; ?></a>
                            </li>
                        <?php endfor; ?>

                        <?php if ($current_page < $total_pages) : ?>
                            <li><a href="http://localhost/envisionprint/admin.php?return&page=<?php echo $current_page + 1; ?>">Next &raquo;</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
